...
all_adult_hospital_inpatient_bed_occupied_7_day_coverage text, 
all_pediatric_inpatient_bed_occupied_7_day_avg text, 
total_icu_beds_7_day_avg text,
icu_beds_used_7_day_avg text, 
inpatient_beds_used_covid_7_day_avg text, 
staffed_icu_adult_patients_confirmed_covid_7_day_avg text);
...
<<<<<<< HEAD
(inpatient_beds_used_covid_7_day_avg >= 0), staffed_adult_icu_patients_confirmed_covid_7_day_avg numeric check (staffed_icu_adult_patients_confirmed_covid_7_day_avg >= 0));
=======
(inpatient_beds_used_covid_7_day_avg >= 0), staffed_icu_adult_patients_confirmed_covid_7_day_avg numeric check (staffed_icu_adult_patients_confirmed_covid_7_day_avg >= 0));
